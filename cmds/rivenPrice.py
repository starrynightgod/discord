...
class rivenPrice(Cog_Extension):
  @commands.command(name='riven',aliases=['紫卡','紫卡查詢'], brief="warframe", description=f"可以查詢warframe.market上的紫卡\n使用方式：{jdata['command_prefix']}riven [武器名稱(可用中文)]")
